...
<ThemeProvider theme={theme}>
        ...
        <div>
            ...
            <main className={styles.main}>
                ...
                <Grid container maxWidth='80%' spacing={3}>
                    <Grid item className={styles.multipleCard} xs={12} sm={12} md={12} lg={12}
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12} style={{marginBottom: 100}}>
                            ...
                            <Grid container maxWidth='100%'>
                                ...
                                <Grid item xs={4} sm={8} md={8}>
                                    <div style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                                        It was just an ordinary day. The criminals gathered around like they did every
                                        night
                            ...
                            making sure bickering stayed bickering, and no fighting broke out. At exactly an hour till
                            ...
                            At exactly midnight, the lights flickered, which had never happened before. It woke up a lot
                            of
                            the criminals, who quickly assumed it was just an error and fell right back asleep.<br></br><br></br>
                ...
                <Grid container maxWidth='80%' spacing={3} style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>

                    <Grid item className={styles.multipleCard} style={{backgroundColor: 'rgb(4, 17, 87, 0.7)'}} sx={{}}
                          xs={12} sm={12} md={4}>
                        GUARD<br></br><br></br>

                        Protectors of the prison. They only have one thought, "Criminals must be imprisoned". Patience
